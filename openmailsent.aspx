<%@ Page Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="openmailsent.aspx.cs" Inherits="openmailsent" Title="Untitled Page" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="lnkatt1" runat="server" CssClass="lbl" onclick="lnkatt1_Click" 
                                            ></asp:LinkButton>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="Button1" runat="server" CssClass="btnn" Text="Reply" 
                                            ...
                                            />
&nbsp;<asp:Button ID="Button2" runat="server" CssClass="btnn" Text="Back to Sent Box" onclick="Button2_Click"  />
                                    </td>
                                </tr>
                            </table>
                        </td>
